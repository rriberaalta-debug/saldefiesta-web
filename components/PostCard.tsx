    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        <div className="flex items-center mb-4" onClick={handleUserClick}>
          <img src={user.avatarUrl} alt={user.username} className="w-10 h-10 rounded-full mr-3 border-2 border-festive-orange" />
          <div>
        ...
        <div className="flex justify-between items-center text-gray-300 mt-auto pt-2">
          <div className="flex gap-4">
             <button onClick={handleLikeClick} className={`flex items-center space-x-1.5 hover:text-white transition-colors ${post.liked ? 'text-red-500' : ''}`}>
                <Heart fill={post.liked ? 'currentColor' : 'none'} size={20} />
...
// FIX: Add default export to make the component available for default import in other files.
